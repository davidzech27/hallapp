...
const Pass: FC<
	Omit<PassType, "visitingEmail" | "visitingName" | "requestedAt" | "arrivedAt" | "leftAt">
> = (pass) => {
		...
		<>
			...
			>
				...
				>
					{
						{
							pending: "You have yet to approve their request",
							denied: "You denied their request",
							approved: "You approved their request",
							left: "Their teacher approved their pass and is on their way to you.",
							arrived: "They have completed their trip!",
						}[pass.status]
					}
				</Animated.Text>
			</AnimatedPressable>
